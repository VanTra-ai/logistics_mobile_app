      ...
      body: ListView(
        ...
        children: [
          ...
          _QuickActionTile(
            ...
            label: 'Cất hàng (Put-away)',
            subtitle: 'Xếp đơn hàng lên kệ',
            color: colorScheme.tertiary,
            onTap: () => context.push(AppRoutes.wmsPutaway),
          ),
          const SizedBox(height: 10),
          _QuickActionTile(
            icon: Icons.local_mall_outlined,
            label: 'Đóng gói & Vật tư',
            subtitle: 'Ghi nhận phí vật tư',
            color: colorScheme.tertiary,
            onTap: () => context.push(AppRoutes.wmsPackaging),
          ),
          const SizedBox(height: 10),
          _QuickActionTile(
            icon: Icons.assignment_outlined,
            label: 'Kiểm kê Kho',
            subtitle: 'Đối soát hàng thực tế',
            color: colorScheme.tertiary,
            onTap: () => context.push(AppRoutes.wmsAudit),
          ),
        ],
      ),
    );
